...
import portfolio_3 from "../../../Assets/images/portfolio/Leçon/lesson.avif"
import portfolio_5 from "../../../Assets/images/portfolio/Leçon/leson2.avif"
import { FaArrowRight } from 'react-icons/fa6'
import { Link } from 'react-router-dom'

const CardFive = ({data_target}) => {
    return (
        <div className={`grid lg:gap-7.5 gap-4 grid-cols-12 sm:grid-rows-[453px] top-0 left-0 transition-all duration-500 ${data_target === "leçons" ? "relative translate-y-0 visible opacity-100" : "absolute translate-y-10 invisible opacity-0"}`}>
