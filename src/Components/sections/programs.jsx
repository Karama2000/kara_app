    ...
    <section className="lg:pt-15 pt-10 lg:pb-15 pb-10 relative">
      <div className="container">
        <div className="text-center flex flex-col items-center">
          <SectionName className={"text-green-foreground"}>Programmes Éducatifs</SectionName>
          <Title size={"3.5xl"} className={"lg:max-w-[630px]"}>Une base solide pour réussir en éveillant la curiosité</Title>
        </div>
