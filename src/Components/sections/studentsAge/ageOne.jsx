                    ...
                    <div className="grid lg:grid-cols-[37%_auto] grid-cols-1 items-center xl:gap-20 gap-10">
                        <div>
                            <div className="lg:max-w-[460px]">
                                <SectionName>Connaissance des Élèves</SectionName>
                                <Title size={"3.5xl"}>Excellence éducative pour tous avec karaScolaire</Title>
                            </div>
                            <SectionDescription className={'pt-5 pb-7.5'}>karaScolaire propose des ressources éducatives adaptées à chaque tranche d'âge, favorisant un apprentissage personnalisé et engageant pour tous les élèves.</SectionDescription>
