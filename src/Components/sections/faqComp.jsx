...
import faq_banner from "../../Assets/images/faq/banner-1.jpg"
      ...
      <div className="container">
        <div className="grid lg:grid-cols-2 grid-cols-1 items-center gap-7.5">
          <div className="max-w-[528px] lg:max-w-full mx-auto">
            <img src={faq_banner} alt="enfant avec ordinateur" />
          </div>
          <div>
            <div className="lg:max-w-[520px] pb-10">
              <SectionName>Questions Fréquentes</SectionName>
              <Title size={"3.5xl"}>Renforcer les enfants grâce à un apprentissage ludique</Title>
            </div>
